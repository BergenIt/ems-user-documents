# Руководство пользователя EMS версия 4.3
...
![Глобальный поиск](./media/EMS_global_search.png "Глобальный поиск")
...
![Поиск в логическом проводнике](./media/EMS_local_logic_search.png "Локальный поиск логического проводника")
...
![Поиск в физическом проводнике](./media/EMS_local_phys_search.png "Локальный поиск физического проводника")
...
![Страница авторизации](./media/EMS_authorization.png "Страница авторизации")
...
![Страница восстановления пароля](./media/EMS_recovery_pass.png "Страница восстановления пароля")
...
![Лицензии](./media/EMS_license.png "Лицензии")
...
![Создание учетной записи нового пользователя](./media/EMS_user.png "Создание пользователя")
...
![Пользователи. Центр идентификации BMC](./media/EMS_centr_ident.png "Пользователи.Центр идентификации")
...
|                                         | Доступ на чтение, создание и изменение | + возможность создания и изменения                                         |                                                                                                                                                                                                                                                                                      |
|                                         | Полный доступ                          | + возможность удаления                                                     |                                                                                                                                                                                                                                                                                      |
| Управление прошивками                   | Уровень доступа отсутствует            | Отображение раздела в интерфейсе системы + возможность выполнения операции | Назначение данного ресурса включает в себя доступ к операциям: Обновление BMC и Обновление BIOS                                                                                                                                                                                      |
...
![Карточка группы ресурсов](./media/EMS_resource_group.png "Карточка группы ресурсов")
...
![Настройка доступа к ресурсам](./media/EMS_resource.png "Настройка доступа к ресурсам")
...
![Доступы к оборудованию](./media/EMS_dostup_k_oborud.png "Доступы к оборудованию")
...
![Журнал аудита](./media/EMS_audit.png "Журнал аудита")
...
![Фоновые задачи](./media/EMS_fon.png "Фоновые задачи")
...
![Настройка времени запуска операций](./media/EMS_device_operation.png "Настройка времени запуска операций")
...
![Запланированные задачи](./media/EMS_plan_task.png "Запланированные задачи")
...
![Задачи ожидающие подтверждения](./media/EMS_approve_task.png "Задачи ожидающие подтверждения")
...
![Пользовательские протоколы. Создание](./media/EMS_custom_protocol.png "Пользовательские протоколы. Создание")
...
![Пользовательские протоколы. Устройства](./media/EMS_custom_protocol_explore.png "Пользовательские протоколы. Устройства")

А также в шаблонах мониторинга устройств. 

![Пользовательские протоколы. Шаблон мониторинга устройств](./media/EMS_custom_protocol_template.png "Пользовательские протоколы. Шаблон мониторинга устройств")
...
![Диагностика кластера](./media/EMS_cluster_setting.png "Диагностика кластера")
...
![Подсети кластера](./media/EMS_cluster_network.png "Подсети кластера")
...
![Синхронизация логического проводника системы с физическим](./media/EMS_logical_view_synk.png "Синхронизация логического проводника системы с физическим")
...
![Логический проводник системы](./media/EMS_logical_view.png "Логический проводник системы")
...
![Дерево размещения оборудования в логическом проводнике](./media/EMS_logical_view_tree.png "Дерево размещения оборудования в логическом проводнике")
...
![Физический проводник системы](./media/EMS_phys_view.png "Физический проводник системы")
...
![Дерево размещения оборудования в физическом проводнике](./media/EMS_phys_view_tree.png "Дерево размещения оборудования в физическом проводнике")
...
![Директория. Меню создания](./media/EMS_action_menu.png "Меню создания")
...
![Стойка. Меню создания](./media/EMS_rack_crea.png "Создание стойки оборудования")
...
![Стойка. Конфигурирование](./media/EMS_rack_config.png "Изменение конфигурации стойки")
...
![Стойка. Оборудование](./media/EMS_rack_add_device.png "Добавление оборудования в стойку")
...
![Стойка. Температура оборудования](./media/EMS_rack_temp.png "Стойка. Температура оборудования")
...
![Стойка. Электропитание оборудования](./media/EMS_rack_elec.png "Стойка. Электропитание оборудования")
...
![Режим обслуживания. Карточка устройства](./media/EMS_service_mode_device_card.png "Режим обслуживания. Карточка устройства")
...
![Режим обслуживания. Логический проводник](./media/EMS_service_mode_device_explorer.png "Режим обслуживания. Логический проводник")
...
![План обслуживания](./media/EMS_service_plan.png "План обслуживания")
...
![Интерфейс обнаружения](./media/EMS_visard_discovery.png "Интерфейс обнаружения")
...
![Обнаружение. Результаты обнаружения](./media/EMS_visard_oborudovanie.png "Обнаружение. Результаты обнаружения")

Для заведения обнаруженных устройств в систему нажмите на кнопку "Перейти в лист обнаружения". 

> ***В случае наличия предварительно настроенного шаблона мониторинга оборудования и указанных стандартных данных подключения по протоколам, система автоматически начнет опрашивать обнаруженные устройства***
...
![Обнаружение. Настройка подключения](./media/EMS_visard_dannie_podluchenia.png "Данные подключения")
...
![Обнаружение. Журнал проверок](./media/EMS_visard_journal.png "Журнал проверок подключения")
...
![Карточка устройства. Гипервизоры](./media/EMS_device_hypervisor.png "Карточка устройства.Гипервизоры")
...
Для создания системы откройте проводник и перейдите в во вкладку "Системы". 
1. Нажмите кнопку "Создать систему".   
2. Укажите название системы, целевой кластер системы, установите целевой показатель SLO и нажмите "Применить".   
Созданная система отобразится в директории.  

> ***Поле ввода названия кластера системы является обязательным полем и влияет на определение сервисов и оборудования на котором доступны данные сервисы***
...
![Визард шаблона мониторинга](./media/EMS_visard_monitoring.png "Визард шаблона мониторинга")
...
6. Подтвердите создание шаблона нажав на кнопку "Закончить".
7. Настройка шаблона событий.
...
![Настройка правил. Выбор протокола](./media/EMS_system_monitoring.png "Настройка правил. Выбор протокола")
...
![Параметры доступа к сервису](./media/EMS_system_monitoring_parametry.png "Параметры доступа к сервису") 
...
![Конфигурации запроса](./media/EMS_system_monitoring_zapros.png "Конфигурации запроса") 
...
![Конфигурации ответа](./media/EMS_system_monitoring_otvet.png "Конфигурации ответа")
...
![Проверка правила](./media/EMS_system_monitoring_proverka.png "Проверка правила. Выбор оборудования")
...
![Карточка устройства. Основная информация](./media/EMS_card_basic_information.png "Основная информация")
   ...
   * Температура - системная метрика отображающая значение температуры устройства. Настройка метрики осуществляется в шаблонах мониторинга оборудования.
   ...
   1.5 ***Блейд-серверы*** - содержит список блейд-серверов, подключенных к блейд-корзине, и возможность быстрого перехода к ним (*раздел доступен только в случае, если выбранное устройство является блейд-корзиной*) 
 
1. **Операционные системы** - содержит информацию об установленной операционной системе на оборудовании, ее хостнейм, архитектуру и версию;
   
2. **Оперативная память**  - содержит информацию об оперативной памяти устройства, а также возможность просмотра графиков ее изменения;
   
3. **Процессоры** - содержит информацию о процессорах и статистических данных их производительности, а также возможностью просмотра графиков их изменения;
...
![Дашборд](./media/EMS_dashboard.png "Дашборд") 
...
Для экспорта отчетов мониторинга по **Ресурсам** откройте дашборд системы. 
...
1. Выберите дашборд с группой устройств, по котором требуется сформировать отчет;
2. Нажмите на кнопку "Выгрузить отчет потребления ресурсов";
...
3. Отметьте устройства, по которым необходимо сформировать отчет. Для выбора устройств используйте навигацию в проводнике;
4. Нажмите на кнопку "Экспортировать".
...
Отчет по забронированным юнитам стойки доступен для формирования из карточки карточки стойки.
...
* Руководство по обновлению Системы EMS с версии 4.2.2 до версии 4.3.0 в режиме одной ноды;  
