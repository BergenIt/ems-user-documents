...
![Режим обслуживания. Логический проводник](./media/EMS_user_guide_files/EMS_service_mode_device_explorer.png "Режим обслуживания. Логический проводник")
...
![План обслуживания](./media/EMS_user_guide_files/EMS_service_plan.png "План обслуживания")
...
##### Отчет потребления ресурсов оборудования

Отчет о потреблении ресурсов оборудования доступен для формирования из дашборда системы.
...
##### Отчет об устройствах директории
...
4. Выберите поля, которые будут включены в отчет;
